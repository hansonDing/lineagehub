...
export default function Sql() {
  ...
  return (
    <div className="space-y-4">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-card">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-center justify-end gap-2 border-t border-slate-100 pt-3">
                  <Button variant="ghost" onClick={openImport} className="mr-auto" disabled={parsing || previewing} data-tour="sql-import">
                  ...
                  <Button onClick={() => void handleSubmit()} loading={parsing} disabled={previewing} data-tour="sql-submit">
      ...
      {/* ============ 区块三:脚本列表 ============ */}
      <Section index={2}>
        <div data-tour="sql-list" className="rounded-lg border border-slate-200 bg-white shadow-card">
